		...
		<div id="dk-speakout-tab-01" class="dk-speakout-hidden dk-speakout-tabcontent">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<label for="theme-default"><input type="radio" name="petition_theme" id="theme-default" value="default" <?php if ( $the_settings->petition_theme == 'default' ) echo 'checked="checked"'; ?> /> <?php _e( 'Default', 'guilro_petitions' ); ?></label>
						<label for="petition-theme-basic"><input type="radio" name="petition_theme" id="petition-theme-basic" value="basic" <?php if ( $the_settings->petition_theme == 'basic' ) echo 'checked="checked"'; ?> /> <?php _e( 'Basic', 'guilro_petitions' ); ?></label>
						<label for="petition-theme-none"><input type="radio" name="petition_theme" id="petition-theme-none" value="none" <?php if ( $the_settings->petition_theme == 'none' ) echo 'checked="checked"'; ?> /> <?php _e( 'None', 'guilro_petitions' ); ?> <span class="description">(<?php _e( 'use', 'guilro_petitions' ); ?> petition.css)</span></label>
					</td>
				</tr>
				<th scope="row"><?php _e( 'Widget Theme', 'guilro_petitions' ); ?></th>
					<td>
						<label for="widget-theme-default"><input type="radio" name="widget_theme" id="widget-theme-default" value="default" <?php if ( $the_settings->widget_theme == 'default' ) echo 'checked="checked"'; ?> /> <?php _e( 'Default', 'guilro_petitions' ); ?></label>
						<label for="widget-theme-none"><input type="radio" name="widget_theme" id="widget-theme-none" value="none" <?php if ( $the_settings->widget_theme == 'none' ) echo 'checked="checked"'; ?> /> <?php _e( 'None', 'guilro_petitions' ); ?> <span class="description">(<?php _e( 'use', 'guilro_petitions' ); ?> petition-widget.css)</span></label>
					</td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td>
						<label for="optin-checked" /><input type="radio" name="optin_default" id="optin-checked" value="checked" <?php if ( $the_settings->optin_default == 'checked' ) echo 'checked="checked"'; ?> /> <?php _e( 'Checked', 'guilro_petitions' ); ?></label>
						<label for="optin-unchecked" /><input type="radio" name="optin_default" id="optin-unchecked" value="unchecked" <?php if ( $the_settings->optin_default == 'unchecked' ) echo 'checked="checked"'; ?> /> <?php _e( 'Unchecked', 'guilro_petitions' ); ?></label>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><?php _e( 'Display signature count', 'guilro_petitions' ); ?></th>
					<td>
						<label for="display-count-yes" /><input type="radio" name="display_count" id="display-count-yes" value="1" <?php if ( $the_settings->display_count == '1' ) echo 'checked="checked"'; ?> /> <?php _e( 'Yes', 'guilro_petitions' ); ?></label>
						<label for="display-count-no" /><input type="radio" name="display_count" id="display-count-no" value="0" <?php if ( $the_settings->display_count == '0' ) echo 'checked="checked"'; ?> /> <?php _e( 'No', 'guilro_petitions' ); ?></label>
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="dk-speakout-tab-02" class="dk-speakout-hidden dk-speakout-tabcontent">
			...
			<table class="form-table">
				...
				<th scope="row"><?php _e( 'Theme', 'guilro_petitions' ); ?></th>
					<td>
						<label for="signaturelist_theme-default"><input type="radio" name="signaturelist_theme" id="signaturelist_theme-default" value="default" <?php if ( $the_settings->signaturelist_theme == 'default' ) echo 'checked="checked"'; ?> /> <?php _e( 'Default', 'guilro_petitions' ); ?></label>
						<label for="signaturelist_theme-none"><input type="radio" name="signaturelist_theme" id="signaturelist_theme-none" value="none" <?php if ( $the_settings->signaturelist_theme == 'none' ) echo 'checked="checked"'; ?> /> <?php _e( 'None', 'guilro_petitions' ); ?> <span class="description">(<?php _e( 'use', 'guilro_petitions' ); ?> petition-signaturelist.css)</span></label>
					</td>
				</tr>
				<tr valign="top">
                ...
                <tr valign="top">
					...
					<td>
						<label for="signaturelist_privacy-enabled"><input type="radio" name="signaturelist_privacy" id="signaturelist_privacy-enabled" value="enabled" <?php if ( $the_settings->signaturelist_privacy == 'enabled' ) echo 'checked="checked"'; ?> /> <?php _e( 'enabled - only show first letter of surname', 'guilro_petitions' ); ?></label>
						<label for="signaturelist_privacy-disabled"><input type="radio" name="signaturelist_privacy" id="signaturelist_privacy-disabled" value="disabled" <?php if ( $the_settings->signaturelist_privacy == 'disabled' ) echo 'checked="checked"'; ?> /> <?php _e( 'disabled', 'guilro_petitions' ); ?> </label>
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="dk-speakout-tab-04" class="dk-speakout-hidden dk-speakout-tabcontent">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<label for="csv-signatures-all"><input type="radio" name="csv_signatures" id="csv-signatures-all" value="all" <?php if ( $the_settings->csv_signatures == 'all' ) echo 'checked="checked"'; ?> /> <?php _e( 'All signatures', 'guilro_petitions' ); ?></label>
						<label for="csv-signatures-single-optin"><input type="radio" name="csv_signatures" id="csv-signatures-single-optin" value="single_optin" <?php if ( $the_settings->csv_signatures == 'single_optin' ) echo 'checked="checked"'; ?> /> <?php _e( 'Only opt-in signatures', 'guilro_petitions' ); ?></label>
						<label for="csv-signatures-double-optin"><input type="radio" name="csv_signatures" id="csv-signatures-double-optin" value="double_optin" <?php if ( $the_settings->csv_signatures == 'double_optin' ) echo 'checked="checked"'; ?> /> <?php _e( 'Only double opt-in signatures', 'guilro_petitions' ); ?> <span class="description">(<?php _e( 'opt-in + confirmed', 'guilro_petitions' ); ?>)</span></label>
					</td>
				</tr>
			</table>
		</div>
