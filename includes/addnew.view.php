...
<div id="poststuff">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-returnurl dk-speakout-subsection <?php if ($petition->requires_confirmation != 1) {
    echo 'dk-speakout-hidden';
} ?>">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-goal dk-speakout-subsection <?php if ($petition->goal < 1) {
    echo 'dk-speakout-hidden';
} ?>">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-date dk-speakout-subsection <?php if ($petition->expires != 1) {
    echo 'dk-speakout-hidden';
} ?>">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-address dk-speakout-subsection <?php if (count($petition->address_fields) == 0) {
    echo 'dk-speakout-hidden';
} ?>">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-custom-field dk-speakout-subsection <?php if ($petition->displays_custom_field != 1) {
    echo 'dk-speakout-hidden';
} ?>">
    ...
    echo 'checked="checked"';
							...
							<div class="dk-speakout-optin dk-speakout-subsection <?php if ($petition->displays_optin != '1') {
    echo 'dk-speakout-hidden';
} ?>">
