            ...
            if (!$expired) {
                ...
                $petition_form = '
					...
					<div class="dk-speakout-petition-wrap '.$css_classes.'" id="dk-speakout-petition-'.$petition->id.'" '.$width.'>
						...
						<a id="dk-speakout-readme-'.$petition->id.'" class="dk-speakout-readme" rel="'.$petition->id.'" style="display: none;"><span>'.__('Read the petition', 'guilro_petitions').'</span></a>
						...
						<form class="dk-speakout-petition">
							...
							<input type="hidden" id="dk-speakout-tweet-'.$petition->id.'" value="'.guilro_petitions_SpeakOut::twitter_encode($petition->twitter_message).'" />
							...
							<div class="dk-speakout-full">
								<label for="dk-speakout-first-name-'.$petition->id.'" class="required">'.__('First Name', 'guilro_petitions').'</label>
								<input name="dk-speakout-first-name" id="dk-speakout-first-name-'.$petition->id.'" value="'.$userdata['firstname'].'" type="text" />
							</div>
							<div class="dk-speakout-full">
								<label for="dk-speakout-last-name-'.$petition->id.'" class="required">'.__('Last Name', 'guilro_petitions').'</label>
								<input name="dk-speakout-last-name" id="dk-speakout-last-name-'.$petition->id.'" value="'.$userdata['lastname'].'" type="text" />
							</div>
							<div class="dk-speakout-full">
								<label for="dk-speakout-email-'.$petition->id.'" class="required">'.__('Email', 'guilro_petitions').'</label>
                ...
                if ($petition->requires_confirmation) {
                    $petition_form .= '
							<div class="dk-speakout-full">
								<label for="dk-speakout-email-confirm-'.$petition->id.'" class="required">'.__('Confirm Email', 'guilro_petitions').'</label>
                ...
                if (in_array('street', $petition->address_fields)) {
                    $petition_form .= '
							<div class="dk-speakout-full">
								<label for="dk-speakout-street-'.$petition->id.'">'.__('Street', 'guilro_petitions').'</label>
                ...
                if (in_array('city', $petition->address_fields)) {
                    $petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-city-'.$petition->id.'">'.__('City', 'guilro_petitions').'</label>
                ...
                if (in_array('state', $petition->address_fields)) {
                    $petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-state-'.$petition->id.'">'.__('State / Province', 'guilro_petitions').'</label>
                ...
                if (in_array('postcode', $petition->address_fields)) {
                    $petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-postcode-'.$petition->id.'">'.__('Post Code', 'guilro_petitions').'</label>
                ...
                if (in_array('country', $petition->address_fields)) {
                    $petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-country-'.$petition->id.'">'.__('Country', 'guilro_petitions').'</label>
