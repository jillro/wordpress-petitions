...
class guilro_petitions_petition_widget extends WP_Widget {
	...
	function guilro_petitions_petition_widget() {
	...
	function widget( $args, $instance ) {
		...
		if ( $get_petition ) {
			...
			$petition_widget .= '
					<div class="dk-speakout-widget-form-wrap">
						...
						<form class="dk-speakout-widget-form">
							...
							<input type="hidden" id="dk-speakout-widget-tweet-' . $petition->id . '" value="' . guilro_petitions_SpeakOut::twitter_encode( $petition->twitter_message ) .'" />
			...
			if ( $expired ) {
				...
				if ( $petition->goal != 0 ) {
					$petition_widget .= '
							<p><div class="dk-speakout-expired-goal"><span>' . __( 'Signature goal', 'guilro_petitions' ) . ':</span> ' . $petition->goal . '</div></p>';
				}
			}
			else {
				$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-first-name-' . $petition->id . '" class="required">' . __( 'First Name', 'guilro_petitions' ) . '</label>
								<input name="dk-speakout-widget-first-name" id="dk-speakout-widget-first-name-' . $petition->id . '" value="' . $userdata['firstname'] . '" type="text" />
							</div>
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-last-name-' . $petition->id . '" class="required">' . __( 'Last Name', 'guilro_petitions' ) . '</label>
								<input name="dk-speakout-widget-last-name" id="dk-speakout-widget-last-name-' . $petition->id . '" value="' . $userdata['lastname'] . '" type="text" />
							</div>
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-email-' . $petition->id . '" class="required">' . __( 'Email', 'guilro_petitions' ) . '</label>
				...
				if ( $petition->requires_confirmation ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-email-confirm-' . $petition->id . '" class="required">' . __( 'Confirm Email', 'guilro_petitions' ) . '</label>
				...
				if ( in_array( 'street', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-street-' . $petition->id . '">' . __( 'Street', 'guilro_petitions' ) . '</label>
				...
				if ( in_array( 'city', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-city-' . $petition->id . '">' . __( 'City', 'guilro_petitions' ) . '</label>
				...
				if ( in_array( 'state', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-state-' . $petition->id . '">' . __( 'State / Province', 'guilro_petitions' ) . '</label>
				...
				if ( in_array( 'postcode', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-postcode-' . $petition->id . '">' . __( 'Post Code', 'guilro_petitions' ) . '</label>
				...
				if ( in_array( 'country', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-country-' . $petition->id . '">' . __( 'Country', 'guilro_petitions' ) . '</label>
