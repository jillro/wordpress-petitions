<div class="wrap" id="guilro-petitions">
	...
	<table class="widefat">
		<thead>
			<tr>
				...
				<th class="guilro-petitions-right"><?php _e('Signatures', 'guilro_petitions'); ?></th>
				<th class="guilro-petitions-right"><?php _e('Goal', 'guilro_petitions'); ?></th>
				<th></th>
			</tr>
		</thead>
		<tfoot>
		...
		<tbody>
		<?php if ($count == 0) {
    echo '<tr><td colspan="5">'.__('No petitions found.', 'guilro_petitions').' </td></tr>';
} ?>
			...
			<tr class="guilro-petitions-tablerow">
				<td>
					...
					<div class="row-actions">
						...
						<span><a href="<?php echo $delete_url; ?>" class="guilro-petitions-delete-petition"><?php _e('Delete', 'guilro_petitions'); ?></a></span>
					</div>
				</td>
				<td><?php echo '[emailpetition&nbsp;id="'.$petition->id.'"]<br />[signaturelist&nbsp;id="'.$petition->id.'"]'; ?></td>
				<td class="guilro-petitions-right"><?php echo number_format($petition->signatures); ?></td>
				<td class="guilro-petitions-right">
				...
				<td class="guilro-petitions-right" style="vertical-align: middle"><a class="button" href="<?php echo $signatures_url; ?>"><?php _e('View Signatures', 'guilro_petitions'); ?></a></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
	...
	<div id="guilro-petitions-delete-confirmation" class="guilro-petitions-hidden"><?php _e('Delete this petition permanently? All of the petition\'s signatures will be deleted as well.', 'guilro_petitions'); ?></div>
